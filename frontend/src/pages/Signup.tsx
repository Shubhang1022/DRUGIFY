      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 font-bold text-2xl mb-4">
            <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sign up to start analyzing genomic data</CardDescription>
          </CardHeader>
